...
service AdminService @(
    ...
    action   createConfiguration(panelAmount : Integer,
                                 modulePower : Integer,
                                 orientation : String,
                                 userId : UUID)        returns SolarPanelConfigurations;

    action   updateConfiguration(id : UUID,
                                 panelAmount : Integer,
                                 modulePower : Integer,
                                 orientation : String) returns SolarPanelConfigurations;
